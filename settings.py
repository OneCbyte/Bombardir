import random, enemy, cnarad, bullet_enemy, pygame, pygame_gui, gun
...
class Settings():
    def __init__(self):
        ...
        self.input = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect(525, 700, 100, 50), manager=self.manage)
